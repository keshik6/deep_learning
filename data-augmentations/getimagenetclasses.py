...
def test_parsesyn():
  filen='./imagenet_data/synset_words.txt'
...
def testparse():
  nm='./imagenet_data/val/ILSVRC2012_val_00049999.xml'
...
#filen='./imagenet_data/synset_words.txt'
#nm='./imagenet_data/val/ILSVRC2012_val_00049999.xml'
#indicestosynsets, synsetstoindices, syssetstoclassdescr = parsesynsetwords(filen)
#label, firstname = parseclasslabel(nm, synsetstoindices)
#print(syssetstoclassdescr)
