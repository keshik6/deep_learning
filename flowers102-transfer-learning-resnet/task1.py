# -*- coding: utf-8 -*-
"""
Created on Fri Mar  8 22:57:33 2019
...
def task1(image_dir, epochs, lr, batch_size = 64):
    
    directory = "./task1_results"
...
#task1('./data/jpg/', './data/imagelabels.mat', './data/setid.mat', 2, 0.0001)