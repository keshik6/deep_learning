# -*- coding: utf-8 -*-
"""
Created on Fri Mar  8 23:57:33 2019
...
def task3(image_dir, epochs, lr, batch_size=64):
    directory = "./task3_results"
    ...
    for child in model.children():
        ...
        if ct <= 7:
            # Freeze layers until 8
            for param in child.parameters():
                param.requires_grad = False
        else:
            # Train layers 8 and 9
            for param in child.parameters():
...
#task3('./data/jpg/', './data/imagelabels.mat', './data/setid.mat', 2, 0.0001)